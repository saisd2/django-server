...
class Upload(models.Model):
    ...
    # upload_user = models.ForeignKey(FocusUser, on_delete=models.CASCADE, related_name='uploads', blank=True)
...
class Comment(models.Model):
    ...
    # user = models.ForeignKey(FocusUser, on_delete=models.CASCADE, related_name='comments', blank=True)